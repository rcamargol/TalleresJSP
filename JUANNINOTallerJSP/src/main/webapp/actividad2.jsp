...
<head>
<meta charset="UTF-8">
<title>Formulario Practica 2</title>
...
<body align="center">
	...
	<form action="respuestaactividad2.jsp" method="post">

		<td>Ingrese el primer numero/limite inferior:</td>
		<td><input type="number" name="num1" value="" size="20" /></td>
		<br> <br>

		<td>Ingrese el segundo numero/limite superior:</td>
