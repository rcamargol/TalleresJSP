...
<meta charset="ISO-8859-1">
	<title>Ejercicio 1 parte 2 inicio</title>
...
<body>
	...
	<form action="ejercicio1parte2resultado.jsp" method="post">
		<table align="center">
		<tr>
		...
		<tr>
			...
			<td style="background-color: Red; "><input type="text" name="num2" value="" size="20"></td>
		</tr>
		<tr>
