...
<% String articulos = request.getAttribute("articulos").toString(); %>
<% String cantidadArticulos = request.getAttribute("cantidadArticulos").toString(); %>
...
<% String calcularValorTotalCompras = request.getAttribute("calcularValorTotalCompras").toString(); %>
<% String obtenerIP = request.getAttribute("obtenerIP").toString(); %>
<% String UltimosDigitosTarjeta = request.getAttribute("UltimosDigitosTarjeta").toString(); %>
<% String nombreProducto = request.getAttribute("nombreProducto").toString(); %>
<html>
<head>
...
<br>
<p>Su compra fue realizada satisfactoriamente por un valor de <%=calcularValorTotalCompras %>.</p>
<br>
<p>Correspondiente a <%=cantidadArticulos %> <%=nombreProducto %></p>
<br>
<p>El precio por unidad fue de: <%=articulos %></p>
<br>
<p>La compra fue realizada con la tarjeta de credito numero: **** **** **** <%=UltimosDigitosTarjeta %> de la franquicia <%=tarjeta %>.</p>
<br>
<p>Fecha de la compra: <%=(new java.util.Date()).toLocaleString()%> </p>
<br>
<p>Direccion IP: <%=obtenerIP %></p>
</section>
<br>
<br>
<center>
<a href="index.jsp">
<button><span></span>Realizar otra compra</button>
</a>
</center>
</body>
</html>