...
<body>
	<section class="formulario">
		<form method="post" action="respuesta1.jsp">
			<center><h1>Operaciones Matematicas</h1></center>
			<input class="control" type="number" name="n1" value="" id="n1" placeholder="Ingresa el primer numero entero" size="40"/>
			<input class="control" type="number" name="n2" value="" id="n2" placeholder="Ingresa el segundo numero entero" size="40"/>
			<input class="boton" type="button" value="REALIZAR OPERACIONES" onClick="valida_envia(this.form)"/>
		</form>
	</section>
