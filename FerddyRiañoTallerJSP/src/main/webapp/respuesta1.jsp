...
<body>
	<section class="respuesta">
		...
		<h3>La suma de los numeros es:  <%=s %> </h3> 
		<h3>La resta de los numeros es:  <%=r %> </h3> 
		<h3>La multiplicacion de los numeros es:  <%=m %> </h3> 
		<h3>La division de los números es:  <%=d %> </h3> 
		<a href="ejercicio1.jsp"><input class="boton" type="button" value="REALIZAR NUEVA OPERACION"/></a>
	</section>
</body>
</html>